...
<body>
    ...
    <!-- ----- -->
    <!-- SLIDE SHOW -->
    <div id="carouselIndicators" class="carousel slide" data-ride="carousel" data-interval="7500">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="first.png" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="second.png" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="third.png" alt="Third slide">
            </div>
        </div>
    ...
    <div clss="container-fluid position-fixed" style="background-color: whitesmoke;">
        ...
        <div class="container">
            <div class="row">
                ...
                INNER JOIN products ON recommend_products.ProductID = products.ProductID
                ...
                ?>
                    <div class="col-sm d-flex justify-content-center">
                        <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px; width: 18rem;">
                            ...
                            <div class="discount"><?php echo $row["Status"]; ?></div>
                            <div class="card-body">
                ...
                <div class="col-sm d-flex justify-content-center">
                    <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px; width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <div class="ori-price">
                                <label style="text-decoration: line-through;">1,200</label>
                            </div>
                            <div class="dis-price">839 บาท</div><br>
                ...
                <div class="col-sm d-flex justify-content-center">
                    <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px; width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <br>
                            <div class="price">2,000 บาท</div><br>
                            <a href="#" class="btn btn-primary btn-lg btn-block">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        </div>
                ...
                <div class="col-sm d-flex justify-content-center">
                    <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px;width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <div class="ori-price">
                                <label style="text-decoration: line-through;">1,000</label>
                            </div>
                            <div class="dis-price">700 บาท</div><br>
                            <a href="#" class="btn btn-primary btn-lg btn-block">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        </div>
                ...
                <div class="col-sm d-flex justify-content-center">
                    <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px;width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <br>
                            <div class="price">1,500 บาท</div><br>
                            <a href="#" class="btn btn-primary btn-lg btn-block">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        </div>
                ...
                <div class="col-sm d-flex justify-content-center">
                    <div class="card" style="border-radius: 20px; margin: 10px; padding: 10px;width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <br>
                            <div class="price">1,890 บาท</div><br>
                            <a href="#" class="btn btn-primary btn-lg btn-block">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        </div>
